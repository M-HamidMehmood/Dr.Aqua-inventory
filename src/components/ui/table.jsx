...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('[&_tr]:border-b bg-muted/60 text-[11px] font-bold text-muted-foreground uppercase tracking-wider', className)}
    {...props}
  />
))
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('p-3.5 align-middle [&:has([role=checkbox])]:pr-0 font-medium text-foreground', className)}
    {...props}
  />
))
